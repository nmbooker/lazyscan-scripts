...
Debian commands for dependencies:
    ...
    # apt-get install libexporter-easy-perl perl-doc libnumber-range-perl liblocal-lib-perl liblockfile-simple-perl libfailures-perl
...
Debian's C<scanimage> outputs lots of SNMP-related stuff when talking to my printer.  If this happens, install C<snmp-mibs-downloader> as described in L<https://wiki.debian.org/SNMP>
...
=head2 Manjaro
    ...
    # sudo pamac install sane imagemagick
    # sudo pamac install cpanminus perl-list-moreutils perl-local-lib perl-moo perl-file-slurp perl-try-tiny perl-tk xterm
    # cd scripts
    # cpanm -l support failures Number::Range Exporter::Easy LockFile::Simple
